...
MySQL - 5.5.5-10.1.31-MariaDB : Database - soivinigniter
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`soivinigniter` /*!40100 DEFAULT CHARACTER SET utf8 */;
...
CREATE TABLE `cliente` (
  ...
  CONSTRAINT `cliente_ibfk_2` FOREIGN KEY (`tipo_Documento`) REFERENCES `tiposdocumentos` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `comprobanteentrada` (
  ...
  KEY `codUserClient` (`codUserClient`),
  CONSTRAINT `comprobanteentrada_ibfk_1` FOREIGN KEY (`codproveedor`) REFERENCES `proveedor` (`id`),
  CONSTRAINT `comprobanteentrada_ibfk_2` FOREIGN KEY (`codUserClient`) REFERENCES `tb_user` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
insert  into `tiposdocumentos`(`id`,`nombre`,`created_at`,`updated_at`,`entry_by`) values (1,'CC.','2018-06-13 11:36:04','2018-06-13 11:36:07',1);
...
CREATE TABLE `usuarios` (
  ...
  CONSTRAINT `fk_usuarios_tiposdocumento1` FOREIGN KEY (`codTipoDocumento`) REFERENCES `tiposdocumentos` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
